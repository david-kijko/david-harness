...
def build_agent_team_brief(intent_contract: dict[str, Any], task_ledger: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    lead_prompt = "\n".join(
        [
            "Create a Claude agent team for this request.",
    ...
    return {
        "agent_team_brief": {
            ...
            "notes": [
                "Use Claude agent teams for parallel lanes to isolate teammate context windows.",
...
def build_parser() -> argparse.ArgumentParser:
    ...
    team_parser = subparsers.add_parser("agent-team-brief", help="Generate a Claude agent team brief from the intent contract and task ledger.")
