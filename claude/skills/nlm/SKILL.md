---
name: nlm
description: Use when working with Google NotebookLM through the nlm CLI: checking auth, creating notebooks, adding sources, querying notebooks, generating studio assets, running research or ingest workflows, syncing sources, or troubleshooting NotebookLM operations.
---
