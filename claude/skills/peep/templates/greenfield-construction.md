...
```bash
/home/david/.claude/skills/peep/bin/peep-render-brief.sh --brief <mental-model.brief.md> --out <mental-model.png>
/home/david/.claude/skills/peep/bin/peep-archive.sh \
